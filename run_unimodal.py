...
DATA_PATH = {
    ...
    'twitter15': {
                # text data
                'train': 'data/NER_data/twitter2015/unimodal/train.txt',
                'dev': 'data/NER_data/twitter2015/unimodal/valid.txt',
                'test': 'data/NER_data/twitter2015/unimodal/test.txt',
                # {data_id : object_crop_img_path}
    ...
    'twitter17': {
                # text data
                'train': 'data/NER_data/twitter2017/unimodal/train.txt',
                'dev': 'data/NER_data/twitter2017/unimodal/valid.txt',
                'test': 'data/NER_data/twitter2017/unimodal/test.txt',
                # {data_id : object_crop_img_path}
...
def main():
    ...
    # parser.add_argument('--caption_dataset', default='./data/RE_data/img_org/caption.csv', type=str, help="The name of dataset.")
    # parser.add_argument('--caption_dataset', default='./data/NER_data/twitter15_caption.csv', type=str,help="The name of dataset.")
    parser.add_argument('--caption_dataset', default='./data/NER_data/twitter17_caption.csv', type=str,help="The name of dataset.")
    ...
    parser.add_argument('--num_epochs', default=100, type=int, help="num training epochs")
    ...
    parser.add_argument('--load_path', default='ckpt/twitter17Model/unimodal/best_model.pth', type=str, help="Load model from load_path")
    # parser.add_argument('--load_path', default=None, type=str, help="Load model from load_path")
    parser.add_argument('--save_path', default='ckpt/twitter17Model/unimodal', type=str, help="save model at save_path")
